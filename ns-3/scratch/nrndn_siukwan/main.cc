...
nrndnExample::nrndnExample() : random_seed(54321),
							   ...
							   accidentNum(0), //默认3
							   method(0),
							   interestFrequency(0.005), //本来是1秒1次,0.0001是10000秒一次
							   hitRate(0),
							   accuracyRate(0),
							   disinterestRate(0),
							   arrivalRate(0),
...
void nrndnExample::InstallTraffics()
{
	...
	UniformVariable rnd(0, nodes.GetN() - 247);
	...
	else
	{
		...
		//uint32_t array[40] = {22, 61, 105, 113, 119, 141, 145, 166, 188, 216, 228, 230, 235, 244, 248, 278, 320, 330, 358, 391, 408, 410, 416, 431, 442, 466, 470, 479, 483, 496, 498, 509, 510, 526, 528, 532, 534, 541, 571, 590};
		//uint32_t array[40] = {6, 9, 17, 47, 71, 84, 94, 146, 151, 152, 157, 159, 163, 165, 168, 196, 197, 203, 204, 218, 229, 232, 246, 252, 270, 278, 292, 317, 350, 362, 383, 393, 395, 396, 429, 438, 446, 451, 469, 483};
		...
		//uint32_t array[50] = {22, 37, 61, 105, 113, 119, 125, 141, 145, 166, 168, 188, 201, 216, 228, 230, 235, 244, 248, 278, 306, 320, 330, 334, 357, 358, 391, 408, 410, 416, 431, 442, 466, 470, 479, 483, 496, 498, 509, 510, 526, 528, 532, 534, 541, 566, 571, 585, 590, 592};
