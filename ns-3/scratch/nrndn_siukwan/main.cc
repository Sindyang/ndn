...
void nrndnExample::InstallTraffics()
{
	...
	else
	{
		...
		//uint32_t array[50] = {6, 9, 15, 17, 38, 47, 49, 71, 80, 84, 94, 109, 146, 151, 152, 157, 159, 163, 165, 168, 196, 197, 203, 204, 218, 229, 232, 238, 246, 252, 256, 267, 270, 278, 292, 314, 317, 350, 362, 370, 383, 393, 395, 396, 429, 438, 446, 451, 469, 483};
