...
void nrndnExample::InstallTraffics()
{
	...
	else
	{
		...
		uint32_t array[50] = {27, 29, 32, 47, 61, 77, 91, 94, 97, 142, 147, 194, 202, 211, 212, 224, 230, 238, 245, 251, 275, 278, 282, 289, 297, 300, 309, 329, 340, 351, 356, 365, 373, 380, 392, 406, 410, 413, 415, 416, 418, 421, 443, 449, 452, 459, 470, 483, 490, 496};
