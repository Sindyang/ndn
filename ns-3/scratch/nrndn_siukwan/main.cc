...
void nrndnExample::InstallTraffics()
{
	...
	else
	{
		...
		uint32_t array[40] = {2, 13, 42, 62, 86, 101, 124, 129, 136, 151, 156, 166, 167, 168, 201, 209, 211, 215, 294, 325, 332, 335, 339, 348, 361, 365, 376, 377, 379, 381, 395, 396, 399, 415, 416, 421, 430, 431, 439, 440};
