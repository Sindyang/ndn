...
void nrndnExample::InstallTraffics()
{
	...
	else
	{
		...
		uint32_t array[40] = {0, 2, 16, 26, 36, 43, 57, 76, 84, 95, 102, 104, 105, 106, 122, 141, 146, 147, 159, 168, 185, 221, 252, 261, 262, 265, 271, 284, 290, 293, 305, 308, 309, 386, 412, 424, 441, 452, 493, 499};
