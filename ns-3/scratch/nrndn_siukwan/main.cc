...
void nrndnExample::InstallTraffics()
{
	...
	else
	{
		...
		uint32_t array[40] = {7, 30, 33, 48, 64, 70, 79, 94, 113, 115, 120, 124, 136, 141, 162, 199, 222, 224, 236, 257, 278, 279, 280, 284, 286, 290, 295, 323, 337, 341, 343, 345, 353, 357, 360, 409, 419, 430, 461, 497};
