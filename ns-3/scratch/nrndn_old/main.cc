...
void nrndnExample::InstallTraffics()
{
	...
	else
	{
		...
		//uint32_t array[40] = {0, 9, 30, 41, 43, 59, 66, 69, 71, 74, 81, 86, 100, 104, 145, 153, 159, 202, 204, 218, 242, 243, 278, 286, 310, 314, 322, 324, 327, 335, 337, 352, 354, 385, 390, 436, 480, 483, 485, 495};
