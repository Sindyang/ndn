...
def get_rsu(roads,in_file):
	...
	for i in range(len(information)-1):
		...
		if road in roads:
			...
			add_line = '\t<vehicle '+vehicle_id+' type="BUS" depart="0" color="1,1,1">'+'\n\t\t' +'<route edges="'+road+'"/>'+'\n\t\t'+'<stop lane="'+road+'_0" endPos="500" until="600"/>'+'\n\t</vehicle>\n'
...
def main():
	in_file1 = 'E:/test/input_net.net.xml'
	in_file2 = 'E:/test/trips.trips.xml'
